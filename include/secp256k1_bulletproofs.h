...
secp256k1_bulletproof_generators *secp256k1_bulletproof_generators_load(const secp256k1_context *ctx, void *data, size_t n) SECP256K1_ARG_NONNULL(1);
...
SECP256K1_API void secp256k1_bulletproof_generators_destroy(
    const secp256k1_context *ctx,
    secp256k1_bulletproof_generators *gen) SECP256K1_ARG_NONNULL(1);
