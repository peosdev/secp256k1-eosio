...
secp256k1_bulletproof_generators *secp256k1_bulletproof_generators_load(const secp256k1_context *ctx, void *data, size_t n) {
...
secp256k1_bulletproof_generators *secp256k1_bulletproof_generators_create(const secp256k1_context *ctx, const secp256k1_generator *blinding_gen, size_t n)
{
    ...
    ret = (secp256k1_bulletproof_generators *)checked_malloc(&ctx->error_callback,
                                                             sizeof(*ret) + (n + 1) * sizeof(*ret->gens));
